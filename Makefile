...
ifeq ($(OS),Darwin)
#MacOS
GLOBAL_LIBS = "-L./ -L/usr/local/lib -L/opt/local/lib -lGLEW -lglut -framework GLUT -framework OpenGL -L/usr/X11/lib /usr/local/lib/libglut.dylib -lsimBlinkyBlocks -lboost_thread-mt  -lboost_system-mt"
else
#Linux, Solaris, ...
GLOBAL_LIBS = "-L./ -L/usr/local/lib  -L/usr/X11/lib -lsimBlinkyBlocks -lpthread -lGLEW -lGL -lGLU -lglut -lboost_thread -lboost_system"
endif
